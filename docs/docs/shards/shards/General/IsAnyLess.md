...
| `Output ➡️` ||Returns true if any element in the input is less than the specified value and false otherwise. | | [`Bool`](../../types/#bool) |
...
Checks if any element in the input is less than the given value. It returns true if any element is less and false otherwise.
