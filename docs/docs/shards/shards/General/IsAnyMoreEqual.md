...
| `Output ➡️` ||Returns true if any element in the input is greater than or equal to the specified value and false otherwise. | | [`Bool`](../../types/#bool) |
...
Checks if any element in the input is greater than or equal to the given value. It returns true if any element is greater or equal and false otherwise.
