...
| `Predicate` | :fontawesome-solid-circle-plus:{title="No"} No  | The shards to use as predicate, if true the item will be popped from the sequence. | `none` | [`Shard`](../../types/#object)[`[Shard]`](../../types/#seq) |
