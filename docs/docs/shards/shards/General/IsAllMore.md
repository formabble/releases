...
| `Output ➡️` ||Returns true if all elements in the input are greater than the specified value and false otherwise. | | [`Bool`](../../types/#bool) |
...
Checks if all elements in the input are greater than the given value. It returns true if all elements are greater and false otherwise.
