...
| `Default` | :fontawesome-solid-circle-xmark:{title="Yes"} Yes  | The default value to use to infer types and output if the variable is not set, key is not there and/or type mismatches. | `None` | [`Any`](../../types/#any) |
