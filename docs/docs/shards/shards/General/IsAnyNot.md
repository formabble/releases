...
| `Output ➡️` ||Returns true if any element in the input is not equal to the specified value and false otherwise. | | [`Bool`](../../types/#bool) |
...
Checks if any element in the input is not equal to the given value. It returns true if any element is not equal and false otherwise.
