...
| `Output ➡️` ||The output is the response from the server through the DELETE request as a string, byte sequence, or table (if the FullResponse parameter is set to true). | | [`{status: Int headers: {String} body: Bytes}`](../../types/#table)[`Bytes`](../../types/#bytes)[`{status: Int headers: {String} body: String}`](../../types/#table)[`String`](../../types/#string)[`Object`](../../types/#object) |
...
This shard sends a HTTP DELETE request to the specified URL and returns the response.
